...
namespace Fdb.Database
{
	class MinifigDecals_Eyebrows
	{
		...
		public MinifigDecals_Eyebrows(Row databaseRow)
		{
			DatabaseRow = databaseRow;
			DatabaseTable = FdbEditor.Database.Tables.First(t => t.Name == "MinifigDecals_Eyebrows");
		}
	}
}
